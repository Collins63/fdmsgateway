                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CustomOutlineBtn(
                                ...
                                height: 50,
                                onTap: ()async{
                                  if(receiptsPending.isNotEmpty){
                                    showDialog(
                                      context: context,
                                      barrierDismissible: false,
                                      builder: (BuildContext context){
                                        return AlertDialog(
                                          title:  const ReusableText(text: "Close Day Alert", style: TextStyle(fontWeight: FontWeight.bold , fontSize: 16)),
                                          content:const SingleChildScrollView(
                                            child: Column(
                                              mainAxisAlignment: MainAxisAlignment.start,
                                              crossAxisAlignment: CrossAxisAlignment.center,
                                              children: [
                                                 ReusableText(text: "Close request stopped", style: TextStyle(fontWeight: FontWeight.bold , fontSize: 16)),
                                                  ReusableText(text: "Please submit all missing receipts ", style: TextStyle(fontWeight: FontWeight.normal , fontSize: 12)),
                                              ],
                                            ),
                                          ),
                                          actions: [
