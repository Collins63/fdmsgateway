...
class DatabaseHelper {
  ...
  String invoices =
    "create table invoices (invoiceId INTEGER PRIMARY KEY AUTOINCREMENT,date TEXT,totalAmount REAL,totalTax REAL , currency TEXT, cancelled INTEGER DEFAULT 0)";
  ...
  String companyDetails =
    "create table companyDetails(companyID INTEGER PRIMARY KEY AUTOINCREMENT , company TEXT , logo TEXT , address TEXT , tel TEXT , branchName TEXT , tel2 TEXT , email TEXT , tinNumber TEXT, vatNumber TEXT ,vendorNumber TEXT , website TEXT , bank TEXT ,bankBranch TEXT , bankAcntName TEXT , bankAcntNo TEXT , baseCurreny TEXT , backUpLocation TEXT , baseTaxPercentage REAL)";
  ...
  String taxPayerDetails =
    "create table taxPayerDetails (taxPayerId INTEGER PRIMARY KEY AUTOINCREMENT, taxPayerName TEXT , taxPayerTin TEXT , taxPayerVatNumber TEXT , taxPayerAddress TEXT , taxPayerEmail TEXT , taxPayerPhone TEXT , taxPayerWebsite TEXT, deviceID int, activationKey TEXT, deviceModelName TEXT , deviceModelVersion TEXT)";

  String creditNotes =
    "create table credit_notes (creditNoteId INTEGER PRIMARY KEY AUTOINCREMENT, receiptGlobalNo TEXT , receiptID TEXT , receiptDate TEXT , receiptTotal REAL , receiptNotes TEXT ,creditNoteNumber TEXT)";
  ...
  await db.transaction((txn) async {
    ...
    for (var item in cartItems) {
      await txn.insert('sales', {
        ...
        'currency': saleCurrency,
        'tax': indiTax, // Calculate per-item tax if necessary add rate here
      });
    }
  });
}
...
//Get all sales
    ...
    Future<void> setDefaultCurrency(int methodId , int defaultTag)async{
      ...
      await db.update(
        'paymentMethods',
        {'defaultMethod': 0}, // Reset all methods to not default
        where: 'defaultMethod = ?',
        whereArgs: [1]
      );
      await db.update(
